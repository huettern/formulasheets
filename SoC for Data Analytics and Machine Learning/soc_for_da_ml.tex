...
% @Last Modified time: 2020-05-05 11:39:21
% ---------------------------------------------------------------------------
...
setvl xdst, xsrc\end{lstlisting}
  ...
  \cgraphic{0.9}{img/multicpugpu.png}

  New GPU allos inter-GPU-connections.
  \cgraphic{0.9}{img/dgx2.png}  
  ...
  \cgraphic{0.9}{img/summitnode.png}  
  ...
  wavefronts.
  \cgraphic{0.7}{img/gpubranch.png}
  ...
  \cgraphic{1.0}{img/hidingshaderstalls.png}
  ...
  \cgraphic{0.8}{img/latencyhiding.png}
  ...
  \cgraphic{0.8}{img/gpuarchmodel.png}
...
__device__ kernelF(A) {
  ...
  \cgraphic{1.0}{img/cudaexample.png}
  Each thread block will be scheduled on a different srteaming multiprocessor (SM).
  \cgraphic{1.0}{img/cudasched.png}
  \cgraphic{0.8}{img/cudaexgrid.png}
...
__device__ kernelF(A) {
  ...
  \cgraphic{0.999}{img/dynamicwarp.png}
  ...
  \cgraphic{0.8}{img/gpusharedmem.png}
...
__global__ void max_kernel(int *a)
{
  ...
  not matter.
  \cgraphic{0.8}{img/reduction.png}
  ...
  \cgraphic{0.8}{img/blocklevelreduction.png}
\begin{lstlisting}[language=C]
for (int stride = 1; stride < blockDim.x; stride *=2) {
  ...
  \cgraphic{0.8}{img/addseqadr.png}
