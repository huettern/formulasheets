...
\begin{align*}
  A_EA_W &= \frac{U_1}{f_p}\frac{D}{B_S}\frac{2\frac{I_{1,avg}}{\sqrt{D}}}{k_f S_{rms}} \approx \frac{U_1I_{1,avg}}{f_p} & 
  \left\lceil \frac{\hat{\Psi}_{phys}}{A_EB_{sat}} \right\rceil &\leq N \leq
  \left\lfloor \frac{1}{2}\frac{S_{rms}}{I_{p,rms}k_f A_w} \right\rfloor &
...
\textbf{Verluste}
\begin{align*}
  P_{cu} &= R_{cu,p}I_{1,rms}^2+R_{cu,s}I_{2,rms}^2 &
  R_{cu} &= \rho_{cu} \frac{l_{cu}}{A_{cu}} &
  l_{cu} &= N\cdot l_n &
  A_{cu} &= \frac{I_{rms}}{S_{rms}}
\end{align*}
