...
%..INTEGRALRECHNUNG
	...
	\newcommand{\dA}{\hspace{1pt}\mathrm{d}A}
	\newcommand{\dx}{\hspace{1pt}\mathrm{d}x}
	\newcommand{\dy}{\hspace{1pt}\mathrm{d}y}
	\newcommand{\dz}{\hspace{1pt}\mathrm{d}z}
	\newcommand{\dr}{\hspace{1pt}\mathrm{d}r}
	\newcommand{\ds}{\hspace{1pt}\mathrm{d}s}
	\newcommand{\dS}{\hspace{1pt}\mathrm{d}S}
	\newcommand{\dt}{\hspace{1pt}\mathrm{d}t}
	\newcommand{\dm}{\hspace{1pt}\mathrm{d}m}
	\newcommand{\dk}{\hspace{1pt}\mathrm{d}k}
	\newcommand{\dl}{\hspace{1pt}\mathrm{d}l}
	\newcommand{\du}{\hspace{1pt}\mathrm{d}u}
	\newcommand{\dv}{\hspace{1pt}\mathrm{d}v}
	\newcommand{\dV}{\hspace{1pt}\mathrm{d}V}
	\newcommand{\dphi}{\hspace{1pt}\mathrm{d}\varphi}
  \newcommand{\domega}{\hspace{1pt}\mathrm{d}\omega}
  \newcommand{\dOmega}{\hspace{1pt}\mathrm{d}\Omega}
  \newcommand{\dgamma}{\hspace{1pt}\mathrm{d}\gamma}
  \newcommand{\df}{\hspace{1pt}\mathrm{d}f}
	\newcommand{\dvarsigma}{\hspace{1pt}\mathrm{d}\varsigma}
	\newcommand{\dtau}{\hspace{1pt}\mathrm{d}\tau}
	\newcommand{\dtheta}{\hspace{1pt}\mathrm{d}\theta}
	\newcommand{\dmu}{\hspace{1pt}\mathrm{d}\mu}
	\newcommand{\dxi}{\hspace{1pt}\mathrm{d}\xi}
	\newcommand{\deta}{\hspace{1pt}\mathrm{d}\eta}
	\newcommand{\dvecl}{\hspace{1pt}\mathrm{d}\vec{l}}
	\newcommand{\dvecS}{\hspace{1pt}\mathrm{d}\vec{S}}
...
\definecolor{orange1}{RGB}{252,234,212}
\newcommand{\eqbox}[1]{\fcolorbox{black}{orange1}{\parbox{\columnwidth}{\begin{center}#1\end{center}}}}
