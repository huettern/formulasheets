...
% @Last Modified time: 2019-10-24 10:08:28
% ---------------------------------------------------------------------------
...
\begin{multicols*}{4}
  ...
  \begin{empheq}{gather*}
    x(t)=\frac{2E_b}{T_b}\cos(2\pi f_it+\theta)+w(t),\quad i=1,2,0\leq t\leq T_b
  \end{empheq}
  ...
  \cgraphic{1}{img/noncohdpsk.png}

  Quadrature implementation of simplified detector:
  \cgraphic{1}{img/quadraturenoncoherent.png}
