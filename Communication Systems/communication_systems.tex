...
% @Last Modified time: 2019-10-31 11:32:46
% ---------------------------------------------------------------------------
...
\begin{multicols*}{4}
  ...
  \textbf{Directivity gain} $g(\theta,\phi)$ Ratio of datiation intensity in a specific direction to the
  avg. radiated power.

  \textbf{Directivity} $D$, maximal directivity gain over all directions

  \textbf{Power gain} $G$ with $\eta_\text{radiation}\in[0,1]$ the datiation efficiency factor.
  ...
  \begin{empheq}{gather*}
    ...
    G=\eta_\text{radiation}D \quad \EIRP=P_tG_theta \\
    \quad A=(\lambda^2/4\pi)G \quad \eta_{ap}=A/A_{ph}
  \end{empheq}

  \textbf{Free-Space Equation}
