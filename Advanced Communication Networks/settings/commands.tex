...
%..INTEGRALRECHNUNG
  ...
  \newcommand{\df}{\hspace{1pt}\mathrm{d}f}
	...
	\newcommand{\dtheta}{\hspace{1pt}\mathrm{d}\vartheta}
...
\definecolor{eqnBlue}{rgb}{0.87, 0.94, 0.99}
\newcommand{\eqbox}[1]{\fcolorbox{black}{eqnBlue}{\parbox{\columnwidth}{\begin{center}#1\end{center}}}}
